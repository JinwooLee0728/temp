...
for i=1:params.sys.n_rbt
    ...
    uL=(norm(veloR)-0.5*omegaR*params.sys.robo_dst)/params.sys.robo_rdi;
    uR=(norm(veloR)+0.5*omegaR*params.sys.robo_dst)/params.sys.robo_rdi;
...
for i=1:params.sys.n_rbt
    ...
    hd_diff=hd_diff+(veloR_actual(1)-veloR_pseudo(1))^2+(veloR_actual(2)-veloR_pseudo(2))^2;   % Squared distance!
end
